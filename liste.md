ls
compose.yml  contracts  data  diff.md  explor.py  ingestion  modeling  notebooks  README.md  requirements.txt  streaming
oualid@oualid-Latitude-E5570:~/Desktop/5g-nidd-de$ ls modeling/
notes.md  src
oualid@oualid-Latitude-E5570:~/Desktop/5g-nidd-de$ ls modeling/src/
analysis.py  eda.py  feature_engineering.py  __init__.py  preprocessing.py  register_model.py  splits.py  train.py
oualid@oualid-Latitude-E5570:~/Desktop/5g-nidd-de$ cat modeling/notes.md 
